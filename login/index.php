  ...
  <header class="mb-auto">
    <div>
      ...
      <nav class="nav nav-masthead justify-content-center float-md-end">
        <a class="nav-link active" aria-current="page" href="http://www.newpcweb.es/index.html">Inicio</a>
        <a class="nav-link" href="index.php">Iniciar Sesion</a>
        <a class="nav-link" href="http://www.newpcweb.es/registrarse.php">Registrarse</a>
		<a class="nav-link" href="http://www.newpcweb.es/informatica.html">PC</a>
		<a class="nav-link" href="http://www.newpcweb.es/consolas.html">Consolas</a>
		<a class="nav-link" href="http://www.newpcweb.es/phones.html">Telefonos y Tablets</a>
		<a class="nav-link" href="http://www.newpcweb.es/otros.html">Servicios</a>
		<a class="nav-link" href="http://www.newpcweb.es/contacto.html">Contacto</a>
      </nav>
    </div>
  </header>
